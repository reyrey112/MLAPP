...
urlpatterns = [
    ...
    path(
        "zenml/pipeline/train/", views.zenml_log_pipeline, name="zenml_train_pipeline"
    ),
    ...
    path(
        "zenml/predictions/upload", views.upload_prediction_csv, name="make_predictions"
    ),
    ...
    path(
        "zenml/inference/predictions",
        views.batch_inference,
        name="zenml_batch_pipeline",
    ),
    path(
        "login/",
